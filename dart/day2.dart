Map<int, List<List<String>>> input = {
  1: [
    ['7 blue', '5 red'],
    ['10 red', '7 blue'],
...
int checkGame(MapEntry<int, List<List<String>>> game) {
  ...
  print('${game.key} is possible!');
  return game.key;
}

void puzzle1() {
  int sum = input.entries
      .fold(0, (previousValue, game) => previousValue + checkGame(game));
  print(sum);
  return;
}
